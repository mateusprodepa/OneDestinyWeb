...
module.exports = {
  ...
  get_user_data: function(id) {
    return `SELECT
    ${TABLES.USUARIOS}.Codigo, ${TABLES.USUARIOS}.id, ${TABLES.USUARIOS}.username, ${TABLES.INFO_USUARIOS}.nickname, ${TABLES.INFO_USUARIOS}.Codigo, ${TABLES.INFO_USUARIOS}.Descricao_Usuario, ${TABLES.INFO_USUARIOS}.Usuario_Status, ${TABLES.INFO_USUARIOS}.Usuario_Back, ${TABLES.INFO_USUARIOS}.Usuario_Imagem,  ${TABLES.USUARIO_TAG}.Cenario_01, ${TABLES.USUARIO_TAG}.Cenario_02, ${TABLES.USUARIO_TAG}.Cenario_03, ${TABLES.USUARIO_TAG}.Cenario_04, ${TABLES.USUARIO_TAG}.Cenario_05,  ${TABLES.USUARIO_TAG}.Sistema_01, ${TABLES.USUARIO_TAG}.Sistema_02, ${TABLES.USUARIO_TAG}.Sistema_03, ${TABLES.USUARIO_TAG}.Sistema_04, ${TABLES.USUARIO_TAG}.Sistema_05
    FROM
    ${TABLES.USUARIOS}, ${TABLES.INFO_USUARIOS}, ${TABLES.USUARIO_TAG}
    WHERE
    ${TABLES.USUARIOS}.id = ${id} AND ${TABLES.INFO_USUARIOS}.Id_Usuario = ${id} AND ${TABLES.USUARIO_TAG}.ID_Usuario = ${id}`;
  },
